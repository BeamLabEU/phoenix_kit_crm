defmodule PhoenixKitCRM.LiveDatabaseGuardTest do
  @moduledoc """
  ...
  describe "check!/1" do
    ...
    test "passes an isolated test database name straight through" do
      assert :ok = LiveDatabaseGuard.check!("phoenix_kit_crm_test")
    end
    ...
    test "an empty or unusual name is never mistaken for a live database" do
      ...
      assert :ok = LiveDatabaseGuard.check!("phoenix_kit_crm_test1")
    end
  end
end
