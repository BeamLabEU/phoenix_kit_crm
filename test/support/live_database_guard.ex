defmodule PhoenixKitCRM.Test.LiveDatabaseGuard do
  @moduledoc """
  ...
  Deliberately ADDED alongside `PhoenixKitCRM.Test.SchemaOwnerGuard`
  ...
  Confirmed live (S014 recon) that it does NOT close this one on its own:
