defmodule PhoenixKitCRM.CorePinConformanceTest do
  ...
  `PhoenixKitWeb.Attachments`, `Users.ViewPrefs` and migration V201's
  `phoenix_kit_user_view_prefs`, which V7 writes), all first shipped in core
  ...
  @must_reject ["1.7.236", "2.0.0", "2.9.4", "2.34.0", "2.37.5", "3.0.0"]
